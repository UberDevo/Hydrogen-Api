...
import rip.vaxp.bridgeapi.repository.PrefixRepository;
...
public class PrefixController {
    ...
    public ResponseEntity<JSONObject> grantPrefix(@RequestBody Map<String, Object> body){
		...
		prefixGrantRepository.save(new PrefixGrant(user, reason, prefix, scopes, expiresIn, System.currentTimeMillis() / 1000, addedBy, addedByIp));
